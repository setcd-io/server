...
export class ErrGRPCEmptyKey extends ConnectError {
  constructor() {
    super("etcdserver: key is not provided", Code.InvalidArgument);
  }
}

export class ErrGRPCKeyNotFound extends ConnectError {
  constructor() {
    super("etcdserver: key not found", Code.InvalidArgument);
  }
}

export class ErrGRPCCompacted extends ConnectError {
  constructor() {
    super(
...
export class ErrGRPCNotImplemented extends ConnectError {
  constructor(message: string) {
    super(`Not implemented: ${message}`, Code.Unimplemented);
  }
}

export class ErrGRPCWatchCanceled extends ConnectError {
  constructor() {
    super("etcdserver: watch canceled", Code.Canceled);
  }
}
